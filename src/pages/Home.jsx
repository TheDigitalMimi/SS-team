    ...
    <div className="bg-white">
      ...
      <section className="bg-navy text-white py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-12 max-w-3xl mx-auto">
            Stop paying agencies $5,000+ for business strategy, branding, and marketing. 
            Get everything you need for less than $100/month.
          </p>
          <Link 
            to="/auth" 
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-navy text-center mb-12">Simple Pricing</h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-8 rounded-lg border-2 border-gray-200">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="text-grey">✓ 5 businesses max</li>
